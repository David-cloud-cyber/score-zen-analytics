import type { Market } from "@/data/analyses";
import { cn } from "@/lib/utils";

const RISK_STYLE: Record<Market["risk"], string> = {
  ...
  return (
    <div className="rounded-2xl bg-card p-4 ring-1 ring-black/5">
      <div className="flex items-start justify-between gap-2">
        ...
        <span className={cn("rounded-md px-1.5 py-0.5 text-[9px] font-black uppercase tracking-wider ring-1", RISK_STYLE[market.risk])}>
          {market.risk}
        </span>
      </div>
